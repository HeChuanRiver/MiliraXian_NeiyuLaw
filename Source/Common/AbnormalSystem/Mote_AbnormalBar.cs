...
namespace MiliraXian.Characters
{
    public class AbnormalBarProperties : DefModExtension
    {
        ...
        public Color backgroundColor = new(0.05f, 0.10f, 0.14f, 0.72f);
        public Color fillColor = new(0.56f, 0.88f, 1f, 0.86f);
        public Vector2 size = new(0.92f, 0.12f);
        ...
        public static readonly AbnormalBarProperties Default = new();
    }
