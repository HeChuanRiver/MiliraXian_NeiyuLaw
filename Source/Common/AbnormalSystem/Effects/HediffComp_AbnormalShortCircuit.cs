...
{
    public class HediffCompProperties_AbnormalShortCircuit : HediffCompProperties
    {
        ...
        {
            compClass = typeof(HediffComp_AbnormalShortCircuit);
        }
    }

    public class HediffComp_AbnormalShortCircuit : HediffComp
    {
        private bool triggered;
        private int nextSteamTick;

        private HediffCompProperties_AbnormalShortCircuit PropsShortCircuit => (HediffCompProperties_AbnormalShortCircuit)props;
