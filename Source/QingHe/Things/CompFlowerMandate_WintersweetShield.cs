...
{
    public class CompProperties_FlowerMandate_WintersweetShield : CompProperties
    {
        ...
        {
            compClass = typeof(CompFlowerMandate_WintersweetShield);
        }
    }

    public class CompFlowerMandate_WintersweetShield : ThingComp
    {
