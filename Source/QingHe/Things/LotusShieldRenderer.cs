...
{
    public class LotusShieldGlowProperties
    {
    ...
    public class LotusShieldVisualProperties
    {
        public static readonly LotusShieldVisualProperties Default = new LotusShieldVisualProperties();
        ...
        public LotusShieldGlowProperties farGlow = new LotusShieldGlowProperties
        {
        ...
        public LotusShieldGlowProperties hitGlow = new LotusShieldGlowProperties
        {
    ...
    public class LotusShieldRenderer
    {
        private readonly CompLotusShield shield;
        private bool visibleLastFrame;
        private float startRealTime;
        private int lastAbsorbTick = -1;

        public LotusShieldRenderer(CompLotusShield shield)
        {
            this.shield = shield;
        }

        private LotusShieldVisualProperties Visual => shield.Props.visual ?? LotusShieldVisualProperties.Default;
        ...
        private static void DrawGlow(LotusShieldGlowProperties glow, Vector3 pos, Vector2 shieldDrawSize, float shieldAlpha, float effectTime, float factor)
        {
