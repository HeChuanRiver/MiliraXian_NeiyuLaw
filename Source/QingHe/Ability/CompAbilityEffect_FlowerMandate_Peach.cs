...
namespace MiliraXian.Characters.QingHe.Ability
{
    public class CompProperties_AbilityFlowerMandate_Peach : CompProperties_AbilityEffect
    {
        ...
        public CompProperties_AbilityFlowerMandate_Peach()
        {
            compClass = typeof(CompAbilityEffect_FlowerMandate_Peach);
        }
    }

    public class CompAbilityEffect_FlowerMandate_Peach : CompAbilityEffect
    {
        public new CompProperties_AbilityFlowerMandate_Peach Props => (CompProperties_AbilityFlowerMandate_Peach)props;
